...
class AssistantManager:
    thread_id = "thread_IXC6hI7pmkjVdHQ0ouXLnZcR"
    assistant_id = "asst_x4LU70x9OP9Q4cPLQ708Lyc2"
    ...
    def __init__(self, model: str = model):
        ...
        # retrieving existing assistant and thread if IDs exist
    ...
    with st.form(key="user_input_form"):
        ...
        if submit_button:
            manager.create_assistant(
                ...
                instructions="You are a personal news article summarizer who knows how to take a list of article's titles and descriptions and then write a short summary of all the news articles",
                tools=[
                    {
                        "type": "function",
                        "function": {
